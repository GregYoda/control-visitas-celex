/* =============================================================================
   MIGRACION -- LEYENDA DEL PIE DEL CORREO (Control de Visitas, Celex)
   Cambia la leyenda del pie del correo de confirmacion: en vez de contactar a
   sistemas@celex.com, ahora dice "por favor contacte a su anfitrion".
   Aplica a Visita y Entrevista (SP compartido). Idempotente (CREATE OR ALTER).
